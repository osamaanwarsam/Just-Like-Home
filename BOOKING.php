						...
						<table>
							<thead>
								<tr class="row100 head">
									...
									<th onclick="w3.sortHTML('#myTable', '.item', 'td:nth-child(1)')" class="cell100 columnbooking1">Name</th>
									<th onclick="w3.sortHTML('#myTable', '.item', 'td:nth-child(2)')" class="cell100 columnbooking2">Seller</th>
									<th onclick="w3.sortHTML('#myTable', '.item', 'td:nth-child(3)')" class="cell100 columnbooking3">Buyer</th>
									<th onclick="w3.sortHTML('#myTable', '.item', 'td:nth-child(4)')" class="cell100 columnbooking4">Book Code</th>
									<th onclick="w3.sortHTML('#myTable', '.item', 'td:nth-child(5)')" class="cell100 columnbooking5">View/Edit</th>
